...
jetToolbox(process, 'ak12', 'jetSequence', 'out', PUMethod='Puppi', JETCorrPayload='AK8PFPuppi', JETCorrLevels=JETCorrLevels, miniAOD=True, runOnMC=True,
...
srcJets = cms.InputTag('selectedPatJetsAK12PFPuppi')
srcSubjets = cms.InputTag('selectedPatJetsAK12PFPuppiSoftDropPacked')
# ---------------------------------------------------------

# DeepNtuplizer
process.load("DeepNTuples.Ntupler.DeepNtuplizerAK12_cfi")
